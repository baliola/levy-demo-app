...
export const LoginForm = ({ props }: { props: ILoginFormProps }): ReactElement => {
              ...
              <div className="h-full flex flex-col gap-y-4">
                <div className="flex flex-col">
                  <div className="flex flex-col gap-y-1">
                    <label 
                      htmlFor="email"
                    >
                      <span className="text-xs tracking-wide">E-mail Address</span>
                    </label>
                    <input
                      id="email"
                      name="email"
                ...
                <div className="mt-6">
                  ...
                  >
                    ...
                    {isSubmitting ? <VscLoading className="text-white m-auto h-5 w-5 font-bold animate-spin" /> : <span className="m-auto">Login</span>}
                  </button>
                </div>
              </div>
            </form>
